...
<div class="lc-pyrun" id="lc-pyrun-{{ _id }}">
  ...
  <div class="lc-pyrun-editor"><div class="lc-pyrun-gutter"><div class="lc-pyrun-gutter-inner"></div></div><textarea class="lc-pyrun-code" rows="{{ _rows }}" spellcheck="false" aria-label="Python editor">{{ _code | escape }}</textarea></div>
