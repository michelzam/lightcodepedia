Feature: Homework — record karma and hand it in
  ...
  A page opened with a param chain (?homework_number=…&learner_id=…&submit_info=…)
  ...
  Scenario: A homework param chain starts a recorded session
    When I navigate to "/tutorial101?homework_number=6a&learner_id=93629601&submit_info=https://example.org/hand-in"
  ...
  Scenario: A graded quiz is recorded into the homework karma
    When I navigate to "/tutorial101?homework_number=6a&learner_id=93629601"
    And I wait for the page to be interactive
